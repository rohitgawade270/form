...
const columns = [
  {field:'photoURL',headerName:'Avatar',width:60,renderCell:()=><Avatar>H</Avatar>,editable:false,sortable:false,filterable:false},
...
export default function DataGridBox() {
  return (
    <Box sx={{ height: 400, width: '100%', marginY:3 }}>
      <DataGrid
        rows={rows}
        columns={columns}
        initialState={{
